...
- (void)reachabilityChanged:(NSNotification *)note{
    ...
    [SWSDKLogger logMessage:@"SwConnectivityManager | reachabilityChanged | status = %@", [self stringForNetworkStatus:status]];
...
- (NSString *)stringForNetworkStatus:(NetworkStatus)status {
    switch (status) {
        case NotReachable:
            return @"NotReachable";
