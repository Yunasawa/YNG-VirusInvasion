...
namespace SupersonicWisdomSDK
{
    internal static class SwStringExtMethods
    {
        ...
        internal static bool SwIsSnakeCase(this string self)
        {
            return self.All(c => char.IsLower(c) || c == '_');
        }
        
        internal static bool SwIsAlphaNumericUnderscores(this string self)
        {
            return self.All(c => char.IsLetter(c) || char.IsNumber(c) || c == '_');
        }
