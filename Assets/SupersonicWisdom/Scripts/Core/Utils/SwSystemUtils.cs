...
namespace SupersonicWisdomSDK
{
    internal class SwSystemUtils
    {
        ...
        private static readonly Lazy<string> LazyOperatingSystemVersion = new Lazy<string>(() => SystemInfo.operatingSystem);
        private static readonly Lazy<string> LazyDeviceModel = new Lazy<string>(() => SystemInfo.deviceModel);
        private static readonly Lazy<string> LazyApplicationVersion = new Lazy<string>(() => Application.version);
        ...
        {
            get { return LazyApplicationVersion.Value; }
        }
        
        public string PlatformVersion
        {
            get { return LazyOperatingSystemVersion.Value; }
        }
        
        public string DeviceModel
        {
            get { return LazyDeviceModel.Value; }
        }
