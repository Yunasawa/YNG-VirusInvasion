...
namespace SupersonicWisdomSDK
{
    internal interface ISwCoreConfigListener
    {
        ...
        void OnConfigResolved([NotNull] ISwCoreInternalConfig swInternalConfig, ISwConfigManagerState state, [NotNull] ISwConfigAccessor swConfigAccessor, ESwConfigSource source);
