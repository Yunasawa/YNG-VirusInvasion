...
namespace SupersonicWisdomSDK
{
    public static class SwConstants
    {
        ...
        public const string BUILD_NUMBER = "2934";
        public const string GIT_COMMIT = "ad09546";

        public const string SDK_VERSION = "8.1.17";
        ...
        internal const string TRIGGERED_BY = "sw_triggered_by";
        internal const string OFFICIAL_INSTALL_SOURCE = "com.android.vending";
