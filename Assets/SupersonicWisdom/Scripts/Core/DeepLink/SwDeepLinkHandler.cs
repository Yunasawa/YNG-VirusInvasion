...
{
    internal class SwDeepLinkHandler : ISwDynamicConfigProvider
    {
        #region --- Constants ---
        ...
        public ESwConfigSource Source { get { return ESwConfigSource.WisdomDeeplink; } }
        ...
        {
            return SwConfigUtils.ResolveDeepLinkConfig(DeepLinkParams);
        }
        ...
        protected internal IEnumerator ApplyDeepLinkByUrl(string url)
        {
            ...
            if (uri.Scheme.Equals(GetDeepLinkScheme(Settings.GetGameId())))
            {
                ...
                OnConfigUpdated?.Invoke(GetConfig());
            }
        }
