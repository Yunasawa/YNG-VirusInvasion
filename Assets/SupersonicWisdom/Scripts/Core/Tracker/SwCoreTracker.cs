...
namespace SupersonicWisdomSDK
{
    internal class SwCoreTracker : ISwTracker
    {
        ...
        public void TrackInfraEvent(Dictionary<string, object> customsDictionary, params string[] customs)
        {
            TrackEventWithParams(ClientCategory.Infra.ToString(), customsDictionary, ClientCategory.Infra, customs);
        }
