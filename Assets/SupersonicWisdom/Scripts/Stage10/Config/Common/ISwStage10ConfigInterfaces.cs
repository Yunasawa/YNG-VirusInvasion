...
namespace SupersonicWisdomSDK
{
    ...
    internal interface ISwStage10ConfigListener
    {
        ...
        void OnConfigResolved([NotNull] ISwStage10InternalConfig swStage10Internal, ISwConfigManagerState state, [NotNull] ISwConfigAccessor swConfigAccessor, ESwConfigSource source);
