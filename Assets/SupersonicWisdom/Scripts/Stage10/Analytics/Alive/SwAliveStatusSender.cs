...
namespace SupersonicWisdomSDK
{
    internal class SwAliveStatusSender : SwBaseAnalyticsManager, ISwCoreConfigListener, ISwGameStateSystemListener, ISwLocalConfigProvider
    {
        ...
        {
            _aliveEventIntervalsRawConfig = swConfigAccessor.GetValue(SwAliveSenderLocalConfig.ALIVE_EVENT_INTERVALS_CONFIG_KEY, SwAliveSenderLocalConfig.ALIVE_EVENT_INTERVALS_CONFIG_VALUE.ToString());
