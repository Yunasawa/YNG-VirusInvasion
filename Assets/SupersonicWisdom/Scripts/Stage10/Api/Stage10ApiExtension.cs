...
namespace SupersonicWisdomSDK
{
    public static class Stage10ApiExtension
    {
        ...
        {
            return self.WasInitialized ? Container.ConfigManager.DynamicConfig.GetValue(key, defaultVal) : defaultVal;
        }
        ...
        [PublicAPI]
        public static void SetResourceData(this SwApi self, ESwResourceTypes param, object value)
        {
            self.RunWithContainerAndReadyOrThrow(() =>
                {
                   Container.ResourceManager.SetData(param, value);
                }, 
