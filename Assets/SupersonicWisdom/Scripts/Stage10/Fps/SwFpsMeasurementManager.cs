...
namespace SupersonicWisdomSDK
{
    internal class SwCoreFpsMeasurementManager : ISwCoreConfigListener, ISwLocalConfigProvider
    {
        ...
        {
            _measurementsInterval = swConfigAccessor.GetValue(SwFpsMonitorLocalConfig.FPS_MEASUREMENTS_INTERVAL_KEY, SwFpsMonitorLocalConfig.FPS_MEASUREMENTS_INTERVAL_VALUE);
            _criticalThreshold = swConfigAccessor.GetValue(SwFpsMonitorLocalConfig.FPS_CRITICAL_THRESHOLD_KEY, SwFpsMonitorLocalConfig.FPS_CRITICAL_THRESHOLD_VALUE);
            _shouldReportInvalidMeasurement = swConfigAccessor.GetValue(SwFpsMonitorLocalConfig.FPS_SHOULD_REPORT_INVALID_FPS_KEY, SwFpsMonitorLocalConfig.FPS_SHOULD_REPORT_INVALID_FPS_VALUE);
        }
