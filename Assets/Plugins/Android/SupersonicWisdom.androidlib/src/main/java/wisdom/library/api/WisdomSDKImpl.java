...
class WisdomSDKImpl implements IWisdomSDK {
    ...
    public void init(Activity initialActivity, WisdomConfigurationDto config) {
        ...
        mAppUpdateManager = new SwAppUpdateManagerWrapper(initialActivity);
    ...
    public String getConnectionStatus() {
        ...
        SwUtils.addToJson(connectionStatusJson, NetworkUtils.KEY_IS_AVAILABLE, mNetworkUtils.isNetworkAvailable());
    ...
    public void initiateUpdate(Activity activity, int updateType) {
        mAppUpdateManager.initiateUpdate(activity, updateType);
    }
    
    @Override
    public void checkForUpdate(){
        mAppUpdateManager.checkForUpdate();
    }

    @Override
    public void addAppUpdateListener(IWisdomAppUpdateListener listener) {
        mAppUpdateManager.addAppUpdateListener(listener);
    }

    @Override
    public void removeAppUpdateListener(IWisdomAppUpdateListener listener) {
        mAppUpdateManager.removeAppUpdateListener(listener);
    }

    @Override
    public boolean openApplication(String appIdentifier) {
        return SwUtils.appLauncher.openApplication(mActivity, appIdentifier);
    }
    ...
    public long captureSessionBackgroundTime() {
        return mSessionManager.captureSessionBackgroundTime();
    }

    @Override
    public long releaseSessionBackgroundTime() {
        return mSessionManager.releaseSessionBackgroundTime();
    }
}
